...
// Компонент TableCellSx для ячеек с обрезкой текста и возможностью переопределения стилей
export const TableCellSx = forwardRef(({ children, sx = {}, ...props }, ref) => {
    return (
        <TableCell
            ref={ref}
            sx={{
                ...
                padding: '8px', // Добавлено для единообразия отступов
                borderBottom: 'none', // Убираем нижнюю границу по умолчанию
                ...sx, // Позволяем переопределять стили через проп sx
            }}
            {...props}
        >
            {children}
...
// Компонент TableCellWrap для ячеек с переносом текста и возможностью переопределения стилей
export const TableCellWrap = forwardRef(({ children, sx = {}, ...props }, ref) => {
    return (
        <TableCell
            ref={ref}
            sx={{
...
// Компонент ResizableTableCell для ячеек с возможностью изменения ширины и переопределения стилей
export const ResizableTableCell = ({ width, onResize, children, sx = {}, ...props }) => {
