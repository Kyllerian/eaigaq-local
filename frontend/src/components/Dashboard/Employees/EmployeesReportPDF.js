// frontend/src/components/Dashboard/Employees/EmployeesReportPDF.js

import React from 'react';
import LogoMVDKZ from "../../../assets/Logo_MVD_KZ.webp";
import { formatDate } from '../../../constants/formatDate';

export default function EmployeesReportPDF({
                                               employeesReportRef,
                                               currentUser,
                                               employeeSearchQuery,
                ...
                >
                    ...
                    <style type="text/css" media="print">
                        {`
                            ...
                            th:nth-child(7), td:nth-child(7) { width: 10%; }  /* Дата последнего входа */
                            /* Итого 100% */
                        `}
                    </style>
